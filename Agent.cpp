...
void Agent::playerPlacer(mcpp::MinecraftConnection& mc, Loc_Builder& loc_Builder, bool mode){
    int build_x = loc_Builder.getX_Coord();
    int build_y = loc_Builder.getY_Coord();
    int build_z = loc_Builder.getZ_Coord();
    int Maze_Length = loc_Builder.getLength();
    int Maze_Width = loc_Builder.getWidth();
    int maxZ = 0;
    int maxX = 0;

    char **mazeStructure;
            mazeStructure = new char*[loc_Builder.getLength()];
            for(int i=0; i < loc_Builder.getLength(); i++){
                mazeStructure[i] = new char[loc_Builder.getWidth()];
            }

    mazeStructure = loc_Builder.getLocStructure();
